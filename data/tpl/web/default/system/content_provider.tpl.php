...
<div class="clearfix">
	...
	<ul class="nav nav-tabs-flow">
		<li<?php  if($do == 'account_list' || $do == 'display' || $do == 'register_flow' || $do == 'flow_control') { ?> class="active"<?php  } ?>>
			...
			<?php  } else if($flow_master_info['status'] == 2 || $flow_master_info['status'] == 3 || empty($flow_master_info['status'])) { ?>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<?php  if(empty($flow_master_info['status']) || $flow_master_info['status'] == 3) { ?>
			<div class="col-xs-5">
	...
	<?php  if($do == 'content_provider') { ?>
		<iframe src="<?php  echo $iframe;?>" marginheight="0" marginwidth="0" frameborder="0" width="100%" style="height:1800px;" scrolling="no" allowTransparency="true"></iframe>
	<?php  } ?>
